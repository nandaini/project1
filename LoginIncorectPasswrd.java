...
public class LoginIncorectPasswrd {
	...
	public static void main(String[] args) throws IOException {
		...
		WebElement passwrd=driver.findElement(By.xpath(prt.getProperty("passwordxpath")));
		passwrd.sendKeys(prt.getProperty("password"));
