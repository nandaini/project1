...
public class ErrorMessageContact {
	...
	public static void main(String[] args) throws IOException {
		...
		WebElement message=driver.findElement(By.xpath(prt.getProperty("ContactMessage1")));
		message.sendKeys(prt.getProperty("Message1"));
